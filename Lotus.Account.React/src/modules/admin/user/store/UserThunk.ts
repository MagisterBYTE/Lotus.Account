...
export const createUserAsyncThunk = createAsyncThunk<IUserResponse, IUserCreateRequest, object>(
  CREATE_USER,
...
export const getUserAsyncThunk = createAsyncThunk<IUser, string, object>(
  GET_USER,
  async (id) => 
  {
...
export const updateUserAsyncThunk = createAsyncThunk<IUser, IUser, object>(
  UPDATE_USER,
  async (updatedUser) => 
  {
...
export const removeUserAsyncThunk = createAsyncThunk<boolean, string, object>(
  REMOVE_USER,
  async (id) => 
  {
...
export const getUsersAsyncThunk = createAsyncThunk<IUsersResponse, IUsersRequest, object>(
  GET_USERS,
  async (filter) => 
  {
